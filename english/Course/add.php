...
if(isset($_POST['addcourse']))
{
    ...
    $sql="insert into courses(lessons, description, term, level_id, category_id) value ('".$le."','".$d."','".$t."',".$id_l.",".$id_c.")";
            ...
            <div class="col-sm-9">
                ...
                <form class="form-horizontal" action="add.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-xs-2">Số bài học</label>
                        <div class="col-xs-10">
                            <input type="text" name="lessons" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-2">Thời gian</label>
                        <div class="col-xs-10">
                            <input type="text" name="term" class="form-control" placeholder="Tháng">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mức độ</label>
                        <div class="col-xs-10">
                            <input type="text" name="level" class="form-control" placeholder="Mã mức độ">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Danh mục</label>
                        <div class="col-xs-10">
                            <input type="text" name="category" class="form-control" placeholder="Mã danh mục">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="addcourse" type="submit" class="btn btn-primary">Thêm</button>
                        </div>
                    </div>
                </form>
            </div>
