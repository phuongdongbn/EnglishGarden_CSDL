...
if(isset($_POST['addclass']))
{
    ...
    if($name)
    {
        ...
        $sql="insert into classes(name, start_date, end_date, price, teacher_id, course_id) values ('".$name."', '".$start."','".$end."','".$price."','".$tea_id."','".$cour_id."')";
            ...
            <div class="col-sm-9">
                ...
                <form class="form-horizontal" action="add.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-xs-2">Tên lớp</label>
                        <div class="col-xs-10">
                            <input type="text" name="name" class="form-control" placeholder="Tên">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Ngày bắt đầu</label>
                        <div class="col-xs-10">
                            <input type="text" name="start" class="form-control" placeholder="YYYY-MM-DD">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Ngày kết thúc</label>
                        <div class="col-xs-10">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mã giảng viên</label>
                        <div class="col-xs-10">
                            <input type="text" name="t_id" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mã khóa học</label>
                        <div class="col-xs-10">
                            <input type="text" name="c_id" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="addclass" type="submit" class="btn btn-primary">Thêm</button>
                        </div>
                    </div>
                </form>
            </div>
