        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php while ($course = mysql_fetch_array($query)){ ?>
                    <tr>
                        ...
                        <td>
                            <?php
                                $sql1 = "select * from levels where id =".$course['level_id'];
                                $query1 = mysql_query($sql1);
                                echo mysql_fetch_array($query1)['sign'];
                            ?>
                        </td>
                        <td>
                            <?php
                            $sql2 = "select * from categories where id =".$course['category_id'];
