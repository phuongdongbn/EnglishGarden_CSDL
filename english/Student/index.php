...
if (isset($_POST['search'])){
    $query = mysql_query("select * from students where fullname like '%".$_POST['tim']."%'");
}
?>
    <!DOCTYPE html>
    <html lang="vi">
                ...
                <div class="col-sm-9">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th>SĐT</th>
                            <th>Email</th>
                            <th>Danh sách lớp tham gia</th>
                            <th>Hành động</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php while ($student = mysql_fetch_array($query)){ ?>
                            <tr>
                                ...
                                <td><?= $student["email"] ?></td>
                                <td><?php
                                    $query1 = mysql_query("select * from class_student where student_id=".$student['id']);
                                    $arr = mysql_fetch_array($query1);
                                    $query2 = mysql_query("select * from classes where id='".$arr['class_id']."'");
