...
if(isset($_POST['editpm']))
{
    ...
    if($u)
    {
        $conn=mysql_connect("localhost","root","");
        mysql_select_db("english");
        $sql="update payment_method set name='".$u."' where id =".$_POST['id'];
        $query=mysql_query($sql);
...
<div>
    <div class="container-fluid no-pad-left">
        <div class="row">
                    ...
                    <ul class="pb20">
                        ...
                        <li><a class="fs18 text-white" href="#" id="btn-8" data-toggle="collapse" data-target="#submenu8" aria-expanded="false">Hình thức giao dịch<span class="caret"></span></a>
                            <ul class="nav collapse" id="submenu8" role="menu" aria-labelledby="btn-8">
                                ...
                                <li><a href="add.php" class="text-white">Thêm hình thức giao dịch</a> </li>
                            </ul>
                        </li>
                        <hr>
            ...
            <div class="col-sm-9">
                <h3>Sửa hình thức giao dịch</h3>
                <form class="form-horizontal" action="edit.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-xs-2">Tên hình thức giao dịch</label>
                        <div class="col-xs-10">
                            <input type="text" name="name" class="form-control" placeholder="Tên" value="<?= mysql_fetch_array($query)['name'] ?>">
                        </div>
                    </div>
                    <input type="hidden" value="<?= $id ?>" name="id">
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="editpm" type="submit" class="btn btn-primary">Sửa</button>
                        </div>
                    </div>
                </form>
            </div>
