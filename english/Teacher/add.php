...
if(isset($_POST['addteacher']))
{
    ...
    if($n)
    {
        ...
        $co = mysql_fetch_array($query1)["id"];
        $sql="insert into teachers(fullname, phone, email, description) value ('".$n."','".$p."','".$a."','".$c."')";
            ...
            <div class="col-sm-9">
                ...
                <form class="form-horizontal" action="add.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input type="text" name="pn" class="form-control" placeholder="SĐT">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="addteacher" type="submit" class="btn btn-primary">Thêm</button>
                        </div>
                    </div>
                </form>
            </div>
