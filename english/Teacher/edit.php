...
if(isset($_POST['editteacher']))
{
    ...
    if($n)
    {
        $conn=mysql_connect("localhost","root","");
        mysql_select_db("english");
        $sql="update teachers set fullname ='".$n."', phone='".$p."', email='".$a."', description='".$c ."' where id=".$_POST['id'];
        $query=mysql_query($sql);
    }
                    ...
                    <ul class="pb20">
                        ...
                        <li><a class="fs18 text-white" href="#" id="btn-4" data-toggle="collapse" data-target="#submenu4" aria-expanded="false">Giảng viên <span class="caret"></span></a>
                            <ul class="nav collapse" id="submenu4" role="menu" aria-labelledby="btn-4">
                                ...
                                <li><a href="add.php" class="text-white">Thêm giảng viên</a> </li>
                            </ul>
                        </li>
                        <hr>
            ...
            <div class="col-sm-9">
                ...
                <form class="form-horizontal" action="edit.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-xs-2">Tên giảng viên</label>
                        <div class="col-xs-10">
                            <input type="text" name="name" class="form-control" value="<?= $arr['fullname'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Số điện thoại</label>
                        <div class="col-xs-10">
                            <input type="text" name="pn" class="form-control" value="<?= $arr['phone'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Email</label>
                        <div class="col-xs-10">
                            <input type="email" name="email" class="form-control" value="<?= $arr['email'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="editteacher" type="submit" class="btn btn-primary">Sửa</button>
                        </div>
                    </div>
                </form>
            </div>
