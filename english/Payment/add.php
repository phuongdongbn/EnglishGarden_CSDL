...
if(isset($_POST['addpayment']))
{
    ...
    if($_POST['ci'] == NULL)
    {
        echo "Vui lòng nhập mã khóa học<br />";
    }
    else
    {
        $ci=$_POST['ci'];
    ...
    if($_POST['si'] == NULL)
    {
        echo "Vui lòng nhập mã giảng viên<br />";
    }
    else
    {
        $si=$_POST['si'];
    ...
    if ($date) {
        ...
        $sql = "insert into payments(payment_date, amount, status, payment_method_id, student_id, class_id) values ('" . $date . "', '" . $amount . "','" . $status . "'," . $pmi . "," . $si . "," . $ci . ")";
            ...
            <div class="col-sm-9">
                ...
                <form class="form-horizontal" action="add.php" method="POST">
                    <div class="form-group">
                        <label class="control-label col-xs-2"> Ngày giao dịch</label>
                        <div class="col-xs-10">
                            <input type="text" name="pdate" class="form-control" placeholder="YYYY-MM-DD">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Số tiền</label>
                        <div class="col-xs-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input type="text" name="status" class="form-control" placeholder="Chưa giao dịch">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mã hình thức</label>
                        <div class="col-xs-10">
                            <input type="text" name="pmi" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mã học viên</label>
                        <div class="col-xs-10">
                            <input type="text" name="si" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-2">Mã lớp học</label>
                        <div class="col-xs-10">
                            <input type="text" name="ci" class="form-control" placeholder="0">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-offset-2 col-xs-10">
                            <button name="addpayment" type="submit" class="btn btn-primary">Thêm</button>
                        </div>
                    </div>
                </form>
            </div>
